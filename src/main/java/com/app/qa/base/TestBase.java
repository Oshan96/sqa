...
public class TestBase {
	 ...
	 public TestBase() {
		 try {
				prop = new Properties();
				FileInputStream ip = new FileInputStream("C:\\Users\\Global\\eclipse-workspace\\Try1\\src\\main\\java\\com\\app\\qa\\configs\\config.properties");
				prop.load(ip);
	 ...
	 public static void initialization(){
			...
			if(browserName.equals("chrome")){
				...
				System.setProperty("webdriver.gecko.driver", "C:\\Users\\Global\\selenium\\geckofiles");	
